        ...
        <nav className="p-6 border-b border-border-color">
            <div className="flex items-center justify-between">
                ...
                <div className="hidden md:flex items-center gap-3">
                    ...
                    <div className="bg-dark-gray-1 border-[rgb(24,24,26)] p-[14px_18px] w-[130px] rounded-xl flex items-center justify-center">
                        <p className="text-light-gray-4 text-base leading-[1em] font-semibold tracking-[0.07em] whitespace-nowrap">
                            {time}
                        </p>
                    </div>
                </div>
