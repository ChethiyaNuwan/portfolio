...
import { rightArrow, stackIcon } from '@/utils/assets'
        ...
        <div className='flex items-start flex-none flex-col flex-nowrap gap-[30px] h-min justify-start overflow-visible relative w-full '>
            ...
            <div className="w-full ">
                <motion.ul
                    ...
                    className="grid gap-[10px] flex-none auto-rows-min h-min justify-center overflow-visible relative p-0 w-full md:grid-cols-[repeat(2,minmax(50px,1fr))] grid-cols-1 lg:grid-rows-[repeat(2,min-content)] ">
                    {
