...
import { flyIcon, linkIcon, rightArrow } from '@/utils/assets'
                ...
                {myShowCases?.slice(0, showData).map((item, index) => (
                    <motion.div
                        ...
                        <div className="bg-very-dark-gray w-full border border-dark-gray-3 rounded-xl flex items-center flex-nowrap flex-col lg:flex-row  gap-5 h-min justify-start overflow-visible p-4 lg:p-[8px_24px_8px_8px] relative ">
                            ...
                            <div className="flex items-start flex-1 flex-col flex-nowrap gap-6 h-min justify-start overflow-visible p-0 relative w-full ">
                                <div className="flex items-start flex-1 flex-col flex-nowrap gap-1 h-min justify-start overflow-visible p-0 relative w-full">
                                    <div className="flex items-center flex-none flex-nowrap gap-5 h-min justify-between overflow-visible p-0 relative w-full">
                                        ...
                                        <div className="flex-none h-min relative">
                                            <Link href={"https://"+item.link} target='_blank' className='bg-almost-black border border-dark-gray-4 flex cursor-pointer items-center flex-nowrap gap-[6px] h-1 justify-center overflow-visible relative w-min rounded-lg custom-padding group hover:bg-dark-gray-4 transition-all duration-500'
                                            >
                                    ...
                                    <div className="mt-3 border-y border-dark-gray-3 flex flex-none gap-3 h-min justify-start overflow-visible px-0 py-1 relative w-full flex-nowrap items-center">
